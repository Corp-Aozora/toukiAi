# Generated by Django 4.2.5 on 2024-02-02 07:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('toukiApp', '0029_alter_numberofproperties_options_house_content_type_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registry_name_and_address_created_by', to=settings.AUTH_USER_MODEL, verbose_name='作成者')),
                ('decedent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registry_name_and_address', to='toukiApp.decedent', verbose_name='被相続人')),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registry_name_and_address_update_by', to=settings.AUTH_USER_MODEL, verbose_name='最終更新者')),
            ],
            options={
                'verbose_name': '登記簿上の住所氏名',
